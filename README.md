...
1. Run `FastChem` to make a chemical abundance table following the instructions described in  [`work/FastChem-lnk_interpolate_dev/README.md`](work/FastChem-lnk_interpolate_dev/README.md)
