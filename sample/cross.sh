...
electron_scattering = 0      ! electron scattering
...
brems_h_minus = 0            ! Bremsstrahlung by H-
brems_h2_minus = 0           ! Bremsstrahlung by H2-
brems_atomicions = 0         ! Bremsstrahlung by atomic ions
/
...
grd_min = 4d0    ! min value of wavenumber grid
grd_max = 6d0    ! max value of wavenumber grid
/
...
jprc = 1  ! number of processes in layer loop
/
&cross_check
code0 = 100 ! hydrogen atom
temp0 = 1d3 ! temperature
/
&block_cyclic
iblock = 1
/
